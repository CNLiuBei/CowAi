...
{
    // ========== 主题选择 ==========
    ImGui::TextColored(ImVec4(0.39f, 0.40f, 0.95f, 1.0f), u8"[主题]");
    
    static int current_theme = -1;
    if (current_theme < 0 || current_theme > 5) 
        current_theme = (config.overlay_theme >= 0 && config.overlay_theme <= 5) ? config.overlay_theme : 0;
    ...
    {
    case 0: preview_color = ImVec4(0.39f, 0.40f, 0.95f, 1.0f); break;  // Indigo (Glass)
    case 1: preview_color = ImVec4(0.08f, 0.72f, 0.65f, 1.0f); break;  // Teal
    case 2: preview_color = ImVec4(0.66f, 0.33f, 0.97f, 1.0f); break;  // Purple
    case 3: preview_color = ImVec4(0.23f, 0.51f, 0.96f, 1.0f); break;  // Blue
    case 4: preview_color = ImVec4(0.20f, 0.83f, 0.60f, 1.0f); break;  // Mint
    case 5: preview_color = ImVec4(0.96f, 0.45f, 0.71f, 1.0f); break;  // Rose
    default: preview_color = ImVec4(0.39f, 0.40f, 0.95f, 1.0f); break;
    }
    ...
    // ========== 透明度设置 ==========
    ImGui::TextColored(ImVec4(0.39f, 0.40f, 0.95f, 1.0f), u8"[窗口]");
